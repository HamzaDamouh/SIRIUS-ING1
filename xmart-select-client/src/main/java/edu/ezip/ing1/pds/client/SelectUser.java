...
public class SelectUser {
    ...
    // for GUI
    public static String retrieveUsers() throws IOException, InterruptedException, SQLException {
    ...
    private static String getUsersInfo(Users users) {
        ...
        for (User user : users.getUsers()) {
            asciiTable.addRule();
            asciiTable.addRow(user.getLastname(), user.getFirstname(), user.getEmail(),user.getGender(),user.getAge(),user.getHeight(), user.getWeight());
        }
        asciiTable.addRule();
